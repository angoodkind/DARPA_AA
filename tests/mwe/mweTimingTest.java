...
import mwe.MweTiming;

public class mweTimingTest extends MweTiming{

	@Test
	public void mweTimingtest() throws IOException {
...
/**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**/
	    ...
	    MweTiming mweTiming = new MweTiming();
	    mweTiming.initializePauseRatioMap();
	    mweTiming.generateMweTimingData(answer,writer);	    
	    
//	    for (String s : mweTiming.getTokenLocationPauseMap().keySet())
//	    	System.out.println(s+" "+mweTiming.getTokenLocationPauseMap().get(s));
	    
	    assertEquals(new ArrayList<Long>(Arrays.asList((long)20,(long)20)),mweTiming.getTokenLocationPauseMap().get("StartOfMwe"));
	    assertEquals(new ArrayList<Long>(Arrays.asList((long)21)),mweTiming.getTokenLocationPauseMap().get("EndOfMwe"));
	    assertEquals(new ArrayList<Long>(Arrays.asList((long)15,(long)15)),mweTiming.getTokenLocationPauseMap().get("MiddleOfMwe"));
	    assertEquals(new ArrayList<Long>(Arrays.asList((long)0)),mweTiming.getTokenLocationPauseMap().get("OutsideOfMwe"));
	}
