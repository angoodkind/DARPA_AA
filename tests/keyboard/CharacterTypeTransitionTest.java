...
import features.keyboard.CharacterTypeTransition;
import keystroke.*;

public class CharacterTypeTransitionTest {
	...
	public void test() {
	    ...
	    CharacterTypeTransition ctt = new CharacterTypeTransition();
	    ctt.generateSearchSpace();
	    ctt.processCharacters(answer.getKeyStrokeList());

	    assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Space_TO_Number"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Space_TO_Function"));
    		assertEquals(new ArrayList<Long>(Arrays.asList((long)20)),ctt.getFeatureMap().get("Consonant_TO_Punctuation"));
    		assertEquals(new ArrayList<Long>(Arrays.asList((long)20,(long)20,(long)20,(long)20,(long)20,(long)20,(long)20)),ctt.getFeatureMap().get("Vowel_TO_Consonant"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Function_TO_Function"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Backspace_TO_Punctuation"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Function_TO_Consonant"));
    		assertEquals(new ArrayList<Long>(Arrays.asList((long)20)),ctt.getFeatureMap().get("Backspace_TO_Backspace"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Function_TO_Punctuation"));
    		assertEquals(new ArrayList<Long>(Arrays.asList((long)20)),ctt.getFeatureMap().get("Backspace_TO_Consonant"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Number_TO_Consonant"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Backspace_TO_Function"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Number_TO_Function"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Punctuation_TO_Consonant"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Backspace_TO_Space"));
    		assertEquals(new ArrayList<Long>(Arrays.asList((long)15)),ctt.getFeatureMap().get("Space_TO_Vowel"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Function_TO_Space"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Function_TO_Vowel"));
    		assertEquals(new ArrayList<Long>(Arrays.asList((long)20,(long)20)),ctt.getFeatureMap().get("Vowel_TO_Space"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Vowel_TO_Punctuation"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Punctuation_TO_Number"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Number_TO_Number"));
    		assertEquals(new ArrayList<Long>(Arrays.asList((long)20,(long)20,(long)20)),ctt.getFeatureMap().get("Consonant_TO_Space"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Function_TO_Number"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Consonant_TO_Function"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Punctuation_TO_Space"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Function_TO_Backspace"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Punctuation_TO_Backspace"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Backspace_TO_Vowel"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Vowel_TO_Number"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Punctuation_TO_Vowel"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Number_TO_Space"));
    		assertEquals(new ArrayList<Long>(Arrays.asList((long)20,(long)20,(long)20,(long)20)),ctt.getFeatureMap().get("Consonant_TO_Consonant"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Space_TO_Backspace"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Vowel_TO_Backspace"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Space_TO_Punctuation"));
    		assertEquals(new ArrayList<Long>(Arrays.asList((long)20)),ctt.getFeatureMap().get("Vowel_TO_Vowel"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Punctuation_TO_Punctuation"));
    		assertEquals(new ArrayList<Long>(Arrays.asList((long)20,(long)20,(long)20,(long)20,(long)20,(long)20,(long)20,(long)20)),ctt.getFeatureMap().get("Consonant_TO_Vowel"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Number_TO_Punctuation"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Punctuation_TO_Function"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Consonant_TO_Number"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Number_TO_Backspace"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Space_TO_Space"));
    		assertEquals(new ArrayList<Long>(Arrays.asList((long)20)),ctt.getFeatureMap().get("Consonant_TO_Backspace"));
    		assertEquals(new ArrayList<Long>(Arrays.asList((long)20,(long)20,(long)20,(long)15)),ctt.getFeatureMap().get("Space_TO_Consonant"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Number_TO_Vowel"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Vowel_TO_Function"));
    		assertEquals(new ArrayList<Long>(),ctt.getFeatureMap().get("Backspace_TO_Number"));
