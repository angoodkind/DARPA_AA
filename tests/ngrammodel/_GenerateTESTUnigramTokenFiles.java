...
public class _GenerateTESTUnigramTokenFiles {

	/**NOT A TEST. ONLY TO GENERATE TEST FILE**/
	@Test
...
/*---------------------------------------*/
	    ...
	    UnigramTokenListGenerator generator = new UnigramTokenListGenerator();
	    generator.addToKeyStrokeUnigramTokens(answer.getKeyStrokeList());
	    generator.addToWordUnigramTokens(answer.getCharStream());
	    generator.updateKeyStrokeUnigramTokenFile();
	    generator.updateWordUnigramTokenFile();
	}
