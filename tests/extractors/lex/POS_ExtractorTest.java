...
public class POS_ExtractorTest {

	@Test
	public void POS_ExtractorCreatePosTagsTest() {
	    ...
	    POS_Extractor pos_extractor = new POS_Extractor(tokens);
	    String[] expectedPosTokens = {"PRP","VBD","IN","DT","NN","NN","."};
		assertArrayEquals(expectedPosTokens,pos_extractor.getPosTags());
	}
	
	@Test
	public void getPosTagMapTest() {
	    ...
	    String[] tokens = tokenize.getUnigramTokens();
	    POS_Extractor pos_extractor = new POS_Extractor(tokens);
	    HashMap<String,Integer> posTagMap = pos_extractor.getPosTagMap();
	    HashMap<String,Integer> expectedPosTagMap = new HashMap<String,Integer>();
	    expectedPosTagMap.put("PRP",1);
	    expectedPosTagMap.put("VBD",1);
	    expectedPosTagMap.put("IN",1);
	    expectedPosTagMap.put("DT",1);
	    expectedPosTagMap.put("NN",2);
	    expectedPosTagMap.put(".",1);
	    
		assertEquals(expectedPosTagMap,posTagMap);
	}
