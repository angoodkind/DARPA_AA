 ...
 */
public class KeyStrokeToFinalTextTest {
	
	@Test
	  public void testKeyStrokeToFinalTextCorrectlyReleaseShift() {
...
@Test
  public void testKeyStrokeToFinalTextCorrectlyDeletesSelectionOnBackspaceUpdate() {
    ...
    String final_text = KeyStroke.keyStrokesToFinalTextEventList(ks).toVisibleTextString();
...
//  List<String> expectedStrings = Arrays.asList(".",".",". ",". ",". ",". I",". I",". I",". I",". I",". I",". TI",". TI",". Th",". Th",". Th",". The");
    ...
    for (int i = 1; i < keyStrokeList.size()+1; i++)
      finalTextActual.add(KeyStroke.keyStrokesToFinalTextEventList(keyStrokeList.subList(0, i)).toVisibleTextString());
