...
import features.predictability.KeyHoldPred;
import keystroke.KeyStroke;

public class KeyHoldPredTest {
	...
	public void test() {
	    ...
	    ks.add(new KeyStroke(KeyEvent.KEY_PRESSED, 661, 83, 's', 30));
	    ks.add(new KeyStroke(KeyEvent.KEY_RELEASED, 662, 83, 's', 31));
	    ks.add(new KeyStroke(KeyEvent.KEY_PRESSED, 670, 46, (char)46, 31));
	    ks.add(new KeyStroke(KeyEvent.KEY_RELEASED, 680, 46, (char)46, 32));
	    ...
	    ge.add(new KeyStroke(KeyEvent.KEY_PRESSED, 661, 83, 's', 30));
	    ge.add(new KeyStroke(KeyEvent.KEY_RELEASED, 662, 83, 's', 31));
	    ge.add(new KeyStroke(KeyEvent.KEY_PRESSED, 670, 46, (char)46, 31));
	    ge.add(new KeyStroke(KeyEvent.KEY_RELEASED, 680, 46, (char)46, 32));
	    ...
	    KeyHoldPred module = new KeyHoldPred();
	    module.extract(dn);
