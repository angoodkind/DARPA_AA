...
import features.predictability.Predictability.TimingToken;
import keystroke.KeyStroke;

public class TimingTokenTest {

	@Test
	public void generateTimingTokensTest() {
...
/*---------------------------------------*/
	    ...
	    ArrayList<TimingToken> tokenList = Predictability.createTimingTokenList(answer);
	    for (TimingToken t : tokenList)
