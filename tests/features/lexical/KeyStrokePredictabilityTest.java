...
import features.predictability.KeyStrokePredictability;
import features.predictability.WordPredictability;
import keystroke.KeyStroke;

/**
 * RUN USING DEBUG MODEL!!
 * @author Adam Goodkind
 */
public class KeyStrokePredictabilityTest {

	@Test
	public void KeyStrokeBigramTrigramPredictabilityTest() {
	    ...
	    ge.add(new KeyStroke(KeyEvent.KEY_PRESSED, 10, KeyEvent.VK_D, 'd', 5));
	    ge.add(new KeyStroke(KeyEvent.KEY_RELEASED, 11, KeyEvent.VK_D, 'd', 6));
...
/*---------------------------------------*/
	    KeyStrokePredictability predictor = new KeyStrokePredictability();
	    predictor.getKeyStrokePredictability(answer.getKeyStrokes());
	    System.out.println(predictor.getKeyStrokeBigramPredictabilityList());
	    ArrayList<Double> bigramExpected = new ArrayList<Double>(Arrays.asList(113.83137525915689,103294.0,10.679595168135814,113.83137525915689,552.3743315508021));
	    ArrayList<Double> trigramExpected = new ArrayList<Double>(Arrays.asList(8682.0,2.0,245.04000000000002,137.8095238095238));
//	    assertEquals(bigramExpected,predictor.getKeyStrokeBigramPredictabilityList());
//	    assertEquals(trigramExpected,predictor.getKeyStrokeTrigramPredictabilityList());

	}
	
//	@Test
//	public void wordBigramTrigramPredictabilityTest() {
//		
//	    EventList<KeyStroke> ks = new EventList<>();
...
//	    ks.add(new KeyStroke(KeyEvent.KEY_PRESSED, 140, 75, 'kt', 7));
//	    ks.add(new KeyStroke(KeyEvent.KEY_RELEASED, 150, 75, 'kt', 8));
...
//	    ge.add(new KeyStroke(KeyEvent.KEY_PRESSED, 140, 75, 'kt', 7));
//	    ge.add(new KeyStroke(KeyEvent.KEY_RELEASED, 150, 75, 'kt', 8));
...
//	    for (KeyStroke kt : ks) {
//		    	StringBuilder keyStrokeBuilder = new StringBuilder();
//		    	keyStrokeBuilder.append(" "+(kt.isKeyRelease()?1:0)+":");
//		    	keyStrokeBuilder.append(Integer.toHexString(kt.getKeyCode())+":");
//		    	keyStrokeBuilder.append((int)kt.getKeyChar()+":");
//		    	keyStrokeBuilder.append(kt.getWhen()+":");
//		    	keyStrokeBuilder.append(kt.getCursorPosition());
//		    	keyStrokeListBuilder.append(keyStrokeBuilder.toString());
//	    }
//	    
//	    Answer answer = new Answer(charStream,finalText,keyStrokeListBuilder.toString(),1,1,1,1,"O",ge);	    
//	    
///*---------------------------------------*/
//	    KeyStrokePredictability ksPredictor = new KeyStrokePredictability();
//	    WordPredictability wordPredictor = new WordPredictability();
//	    
//	    wordPredictor.getWordPredictability(answer);
//	    ArrayList<Double> bigramExpected = new ArrayList<Double>(Arrays.asList(2908820.0000000005, 15.0, 1163540.0, 20.0, 490875.0, 20.0));
//	    ArrayList<Double> trigramExpected = new ArrayList<Double>(Arrays.asList(15.0, 20.0, 20.0, 15.0, 20.0));
//	    assertEquals(bigramExpected,wordPredictor.getWordBigramPredictabilityList());
//	    assertEquals(trigramExpected,wordPredictor.getWordTrigramPredictabilityList());
//	}
