...
import features.lexical.ConsonantFrequency;
import features.pause.KSE;
import keystroke.KeyStroke;

public class ConsonantFrequencyTest {
	...
	public void test() {
		...
		ConsonantFrequency cf = new ConsonantFrequency();
		double commonRatio = cf.getCommonConsonantRatio(keyPressKSEs);
		double rareRatio = cf.getRareConsonantRatio(keyPressKSEs);
		
		assertEquals(0.2962962962962963,commonRatio,0.001);
		assertEquals(0.037037037037037035,rareRatio,0.001);
	}
