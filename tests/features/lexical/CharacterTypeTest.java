...
import features.lexical.CharacterType;
...
public class CharacterTypeTest {
	...
	public void test() {
		...
		double alphaCharRatio = ct.getAlphaCharRatio(keyPressKSEs);
		double numberCharRatio = ct.getNumberCharRatio(keyPressKSEs);
		double uppercaseRatio = ct.getUppercaseRatio(finalText);
		double spacebarRatio = ct.getSpacebarRatio(keyPressKSEs);
		double vowelRatio = ct.getVowelRatio(finalText);
		
		assertEquals(0.7714285714285715,alphaCharRatio,0.001);
		assertEquals(0.0,numberCharRatio,0.001);
		assertEquals(0.0,uppercaseRatio,0.001);
		assertEquals(0.14285714285714285,spacebarRatio,0.001);
		assertEquals(0.36,vowelRatio,0.01);
	}
