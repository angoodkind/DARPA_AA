...
/**
 * @author agoodkind
 * Transition times between each row
 */
public class RowTransitionSpeed implements ExtractionModule {
	...
	public void generateSearchSpace() {
		for (String row1 : rowNames)
			for (String row2 : rowNames)
				searchSpace.add(row1+"_TO_"+row2);
	}
