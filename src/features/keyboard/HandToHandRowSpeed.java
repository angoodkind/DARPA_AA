 ...
 */
public class HandToHandRowSpeed implements ExtractionModule {
...
//	    for (Feature f : output) System.out.println(f.toTemplate());
	...
	public String getTransitionType(LinkedList<KSE> buffer) {
		...
		String keystroke2Category = buffer.getLast().kseGetHand()+"_"+buffer.getLast().kseGetRow();
