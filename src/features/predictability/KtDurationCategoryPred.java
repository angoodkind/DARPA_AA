 ...
 */
public class KtDurationCategoryPred extends Predictability implements ExtractionModule {
...
//		for (String category : categories)
			for (Integer key0 : keySet)
				for (Integer key1 : keySet)
					featureMap.put((/**category+"_"+**/KeyStroke.vkCodetoString(key0)+"_"+KeyStroke.vkCodetoString(key1)),
...
//						category = "intraWord";
					...
					String digraph = /**category+"_"+**/prevKStr+"_"+kStr;
...
//					}
		...
		for (String s : featureMap.keySet()) {
				output.add(
						new Feature("DN_KT_Predict_"+s, featureMap.get(s)));
			}
		return output;
	}
